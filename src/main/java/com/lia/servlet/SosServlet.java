...
public class SosServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // description is required too, not just location - otherwise it's
            // too easy to fire off a location-only alert with nothing useful
            // in it (or as a prank). Frontend already marks it required; this
            // is just the backend backstop.
